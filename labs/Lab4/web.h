 ...
 * @page: the webpage to write to the file
 * @fileNum: the file number (the name of the file)
 * @directPath: the path to the directory that the file will be written to
 * 
 * Returns 0 on success.
 * Returns 1 on memory allocation failure.
 * Returns 2 on file opening failure.
 */
